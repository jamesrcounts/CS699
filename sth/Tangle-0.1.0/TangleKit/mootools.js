...
(function () {
    ...
    a.implement({implement:b.overloadSetter(), extend:m.overloadSetter(), alias:function (i, s) {
    ...
    Array.implement({forEach:function (u, v) {
    ...
    Object.extend({merge:function (z, u, t) {
        if (o(u) == "string") {
            return h(z, u, t);
        }
